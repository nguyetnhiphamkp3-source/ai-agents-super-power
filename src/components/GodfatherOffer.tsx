  ...
  const agents: Agent[] = [
    {
      ...
      image: "Agent Avatar Builder.webp"
    },
    {
      id: "02",
    ...
    },
    {
      ...
      image: "Agent Hero Mechanism.webp"
    },
    {
      id: "05",
      ...
      image: "Agent Offer Architect.webp"
    },
    {
      id: "06",
      ...
      image: "Agent Ad Copy Machine.webp"
    },
    {
      id: "07",
      ...
      image: "Agent VSL Scriptwriter-.webp"
    },
    {
      id: "08",
      ...
      image: "Agent Funnel Strategist.webp"
    },
    {
      id: "09",
    ...
    },
    {
      ...
      image: "Agent Sales Call Script.webp"
    },
    {
      id: "11",
      ...
      image: "Agent Follow-Up Engine.webp"
    },
    {
      id: "12",
    ...
    <section className="bg-white section-padding font-sans text-[#000000]" id="godfather-offer">
      <div className="max-w-7xl mx-auto container-padding">
        ...
        <div className="max-w-5xl mx-auto mb-12 md:mb-16">
          <img 
            src={`${import.meta.env.BASE_URL}full-12-agent.webp`}
            alt="12 AI Agent" 
        ...
        <FeedbackInline image="fb17.webp" />

        <div className="max-w-[690px] mx-auto mb-10 p-6 md:p-10 rounded-none bg-[#f6edff] text-center">
          <div className="mb-6">
            <h3 className="text-[22px] md:text-[44px] font-display uppercase leading-tight tracking-tight text-black text-balance">
          ...
          <div className="pt-4 border-0">
            <p className="text-[18px] md:text-[28px] font-bold leading-tight !font-sans uppercase tracking-wide text-black text-balance">
        ...
        <div className="max-w-[690px] mx-auto space-y-8 md:space-y-10 text-base md:text-[27px] leading-relaxed text-left !font-sans tracking-wide">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 space-y-4 md:space-y-5 shadow-sm">
            ...
            <img
              src={`${import.meta.env.BASE_URL}flow-3step.webp`}
